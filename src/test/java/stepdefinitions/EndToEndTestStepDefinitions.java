...
//        response = get("https://thinking-tester-contact-list.herokuapp.com/user/me");
//    }
//
...
//    public void userSendsAPOSTRequestToLogInWithTheFollowingData(String requestData) throws JsonProcessingException {
...
//                .body(expectedData)
//                .post("/users/login");  // Adjust the endpoint here if needed
//        response.prettyPrint();
//    }
//
//
...
//        // Generate authentication token (assuming it's retrieved from somewhere)
